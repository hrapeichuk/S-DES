...
class SDES
{
    ...
    public static int permute( int x, int p[], int pmax)
    {
        ...
        {
            y <<= 1; //<<= - сдвиг влево с присваиванием
            y |= (x >> (pmax - p[i])) & 1; //|= - побитовое ИЛИ с присваиванием, >> - сдвиг вправо
        }
        return y;
    }
    ...
    public static int F( int R, int K)
    {
        ...
        int t0 = (t >> 4) & 0xF; //& -  побитовое И, 0000 1111 (0xF)
        int t1 = t & 0xF;
        t0 = S0[ ((t0 & 0x8) >> 2) | (t0 & 1) ][ (t0 >> 1) & 0x3 ]; //|   -  побитовое ИЛИ
    ...
    public SDES( int K)
    {
        ...
        int t1 = (K >> 5) & 0x1F;
        int t2 = K & 0x1F;
        t1 = ((t1 & 0xF) << 1) | ((t1 & 0x10) >> 4); //| -  побитовое ИЛИ
        t2 = ((t2 & 0xF) << 1) | ((t2 & 0x10) >> 4);
        K1 = permute( (t1 << 5)| t2, P8, P8max);
        t1 = ((t1 & 0x7) << 2) | ((t1 & 0x18) >> 3); // 0001 1000 (0x18 = 24)
